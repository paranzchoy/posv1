(function () {
  ...
  var script = {
    ...
    data: function data() {
      return {
        ...
        item: 0,
        items: [
          { text: "POS v1", icon: "mdi-point-of-sale" } ],
        page: "",
        fav: true,
        menu: false,
        message: false,
    ...
    methods: {
      ...
      go_about: function go_about(){
        var win = window.open('https://www.facebook.com/rapidsignalelectronics', '_blank');
        win.focus();
      },
    ...
    created: function () {
      this.$nextTick(function () {
        ...
        evntBus.$on("set_company", function (data) {
          ...
          this$1.company_img = data.company_logo ? data.company_logo :this$1.company_img ;
        });
      });
      ...
      [
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _c("v-toolbar-title", { staticClass: "text-uppercase green--text" }, [
              _c("span", [_c("strong", [_vm._v("BAMBOO")])]),
              _vm._v(" "),
            ...
            _c(
              "v-btn",
              { attrs: { text: "", color: "grey" }, on: { click: _vm.go_desk } },
              [_c("span", { attrs: { right: "" } }, [_vm._v("Desk")])]
            )
          ],
          1
        ),
  ...
  __vue_render__._withStripped = true;
    ...
    function __vue_normalize__(
      ...
      component.__file = "/home/frappe/frappe-bench/apps/posawesome/posawesome/public/js/posapp/components/Navbar.vue";
      ...
      [
          ...
          [
            ...
            _c(
              ...
              [
                _c(
                  "v-col",
                  { staticClass: "pb-0 mb-2", attrs: { cols: "9" } },
                  [
                    _c("v-text-field", {
                      attrs: {
                        dense: "",
        ...
        _c(
          "v-card",
          {
            ...
            staticStyle: { "max-height": "13vh", height: "13vh" }
          },
          [
            _c(
              "v-row",
                ...
                _c(
                  ...
                  [
                    _c(
                      ...
                      [
                        _c("v-btn", { attrs: { value: "card" } }, [
                          _vm._v("Card View")
                        ]),
                        _vm._v(" "),
                        _c("v-btn", { attrs: { value: "list" } }, [
                          _vm._v("List View")
                        ])
                      ],
                      1
                  ...
                  [
                    _c(
                      "v-btn-toggle",
                      {
                        ...
                        model: {
                          value: _vm.favourites_view,
                          callback: function($$v) {
                            _vm.favourites_view = $$v;
                          },
                          expression: "favourites_view"
                        }
                      },
                      [
                        _c("v-btn", { attrs: { value: "True" } }, [
                          _vm._v("Favourites")
                        ])
                      ],
                      1
  ...
  __vue_render__$1._withStripped = true;
    ...
    function __vue_normalize__$1(
      ...
      // For security concerns, we use only base name in production mode.
      component.__file = "/home/frappe/frappe-bench/apps/posawesome/posawesome/public/js/posapp/components/pos/ItemsSelector.vue";
                        ...
                        _c(
                          ...
                          [
                            _c("v-list-item-title", {
                              ...
                              domProps: {
                                innerHTML: _vm._s(data.item.customer_name)
                              }
                            }),
                            _vm._v(" "),
                  ...
                  fn: function() {
                    return [
                      _c(
                        ...
                        { attrs: { mode: "out-in" } },
                        [
                          _c("v-icon", { on: { click: _vm.new_customer } }, [
                            _vm._v("mdi-plus")
                          ])
                        ],
                        1
  ...
  __vue_render__$2._withStripped = true;
    ...
    function __vue_normalize__$2(
      ...
      // For security concerns, we use only base name in production mode.
      component.__file = "/home/frappe/frappe-bench/apps/posawesome/posawesome/public/js/posapp/components/pos/Customer.vue";
  ...
  var script$3 = {
    ...
    methods: {
      remove_item: function remove_item(item) {
        var index = this.items.findIndex(function (el) { return el === item; });
        this.items.splice(index, 1);
        var idx = this.expanded.findIndex(function (el) { return el === item; });
        if (idx >= 0) {
      ...
      add_item: function add_item(item) {
        ...
        var index = this.items.findIndex(
          function (el) { return el.item_code === item.item_code && el.uom === item.uom; }
        );
        if (index === -1) {
      ...
      save_draft_invoice: function save_draft_invoice() {
        var vm = this;
        var doc = this.get_invoice_doc();
        frappe.call({
      ...
      validate: function validate() {
        ...
        this.items.forEach(function (item) {
          if (
            this$1.pos_profile.update_stock &&
            this$1.stock_settings.allow_negative_stock != 1
          ) ;
          ...
          if (this$1.pos_profile.posa_allow_user_to_edit_additional_discount) {
            var clac_percentage = (this$1.discount_amount / this$1.subtotal) * 100;
            if (clac_percentage > this$1.pos_profile.posa_max_discount_allowed) {
              evntBus.$emit('show_mesage', {
                text: ("The discount should not be higher than " + (this$1.pos_profile.posa_max_discount_allowed) + "%"),
                color: 'error',
              });
              value = false;
            }
          ...
          if (this$1.invoice_doc.is_return) {
            ...
            if (this$1.subtotal * -1 > this$1.return_doc.total) {
              evntBus.$emit('show_mesage', {
                text: ("Return Invoice Total should not be higher than " + (this$1.return_doc.total)),
                color: 'error',
              });
              value = false;
              return value;
            ...
            this$1.items.forEach(function (item) {
              ...
              if (!return_item) {
                evntBus.$emit('show_mesage', {
                  text: ("The item " + (item.item_name) + " cannot be returned because it is not in the invoice " + (this$1.return_doc.name)),
                  color: 'error',
                });
                value = false;
                return value;
        ...
        frappe.call({
          ...
          callback: function (r) {
            if (r.message) {
              items.forEach(function (item) {
                var updated_item = r.message.find(
                  function (element) { return element.item_id == item.item_id; }
                );
                item.actual_qty = updated_item.actual_qty;
                item.serial_no_data = updated_item.serial_no_data;
                item.batch_no_data = updated_item.batch_no_data;
            ...
            frappe.db
              ...
              .then(function (ref) {
                ...
                if (loyalty_program) {
                  ...
                  vm.customer_info = Object.assign({}, message, {customer: vm.customer});
                  resolve();
                }
              });
          });
      ...
      set_batch_qty: function set_batch_qty(item, value) {
      ...
      gotoSearchItems: function gotoSearchItems(e) {
      ...
      [
        _c(
          "v-card",
          {
            ...
            staticStyle: { "max-height": "65vh", height: "65vh" }
          },
          [
            _c("Customer"),
            _vm._v(" "),
                                      ...
                                      [
                                        _c("v-select", {
                                          attrs: {
                                            ...
                                            "item-value": "uom",
                                            "hide-details": "",
                                            disabled: !!_vm.invoice_doc.is_return
                                          },
                                          on: {
                                            change: function($event) {
        ...
        _c(
          ...
          [
            _c(
              "v-col",
              { staticClass: "pt-0 pr-0", attrs: { cols: "8" } },
              [
                _c(
                  "v-card",
                  {
                    staticClass: "cards mb-0 mt-3 py-0 grey lighten-5",
                    staticStyle: { "max-height": "25vh", height: "25vh" }
                  },
                  [
                    _c(
                      "v-row",
            ...
            _c(
              "v-col",
              { staticClass: "pt-0 pr-3", attrs: { cols: "4" } },
              [
                _c(
                  "v-card",
                  {
                  ...
                  [
                    ...
                    _c(
                      "v-row",
                      { staticStyle: { height: "54%" }, attrs: { align: "end" } },
                      [
                        _c(
                          "v-col",
                          { attrs: { cols: "12" } },
  ...
  __vue_render__$3._withStripped = true;
    ...
    function __vue_normalize__$3(
      ...
      // For security concerns, we use only base name in production mode.
      component.__file = "/home/frappe/frappe-bench/apps/posawesome/posawesome/public/js/posapp/components/pos/Invoice.vue";
  ...
  var script$4 = {
    ...
    watch: {
      company: function company(val) {
        ...
        this.pos_checkout_counters_data.forEach(function (element) {
          // if (element.company === val) {
          //   this.pos_checkout_counters.push(element.name);
          // }
          this$1.pos_checkout_counters.push(element.counter_name);

          if (this$1.pos_checkout_counters.length) {
            this$1.pos_checkout_counter = this$1.pos_checkout_counters[0];
          } else {
            this$1.pos_checkout_counter = '';
          }
        });      
      },
              ...
              [
                _c("v-card-title", [
                  _c("span", { staticClass: "headline indigo--text" }, [
                    _vm._v("Create POS Opening Shift")
                  ])
                ]),
                _vm._v(" "),
                _c(
                          ...
                          [
                            ...
                            _c(
                              ...
                              [
                                _c("v-autocomplete", {
                                  attrs: {
                                    items: _vm.pos_checkout_counters,
                                    label: "POS Counter",
                                    required: ""
                                  },
                                  model: {
                                    value: _vm.pos_checkout_counter,
                                    callback: function($$v) {
                                      _vm.pos_checkout_counter = $$v;
                                    },
                                    expression: "pos_checkout_counter"
                                  }
                                })
                              ],
                              1
  ...
  __vue_render__$4._withStripped = true;
    ...
    function __vue_normalize__$4(
      ...
      // For security concerns, we use only base name in production mode.
      component.__file = "/home/frappe/frappe-bench/apps/posawesome/posawesome/public/js/posapp/components/pos/OpeningDialog.vue";
  ...
  var script$5 = {
    ...
    computed: {
      total_payments: function total_payments() {
        var total = flt(this.invoice_doc.loyalty_amount);
        this.invoice_doc.payments.forEach(function (payment) {
    ...
    return _c(
      ...
      [
        _c(
          ...
          {
            staticClass: "selection mx-auto grey lighten-5",
            staticStyle: { "max-height": "78vh", height: "78vh" }
          },
          [
            _c("v-progress-linear", {
              attrs: {
                  ...
                  [
                    _c(
                      ...
                      [
                        ...
                        !_vm.invoice_doc.is_return
                          ? _c("v-switch", {
                              attrs: { flat: "", label: "Is Credit Sale" },
                              model: {
                          ...
                          ? _c(
                              "v-menu",
                              {
                                ...
                                attrs: {
                                  ...
                                  "return-value": _vm.invoice_doc.due_date,
  ...
  __vue_render__$5._withStripped = true;
    ...
    function __vue_normalize__$5(
      ...
      // For security concerns, we use only base name in production mode.
      component.__file = "/home/frappe/frappe-bench/apps/posawesome/posawesome/public/js/posapp/components/pos/Payments.vue";
  ...
  __vue_render__$6._withStripped = true;
    ...
    function __vue_normalize__$6(
      ...
      // For security concerns, we use only base name in production mode.
      component.__file = "/home/frappe/frappe-bench/apps/posawesome/posawesome/public/js/posapp/components/pos/Drafts.vue";
    ...
    var Drafts = __vue_normalize__$6(
  ...
  __vue_render__$7._withStripped = true;
    ...
    function __vue_normalize__$7(
      ...
      // For security concerns, we use only base name in production mode.
      component.__file = "/home/frappe/frappe-bench/apps/posawesome/posawesome/public/js/posapp/components/pos/ClosingDialog.vue";
    ...
    var ClosingDialog = __vue_normalize__$7(
  ...
  __vue_render__$8._withStripped = true;
    ...
    function __vue_normalize__$8(
      ...
      // For security concerns, we use only base name in production mode.
      component.__file = "/home/frappe/frappe-bench/apps/posawesome/posawesome/public/js/posapp/components/pos/NewCustomer.vue";
    ...
    var NewCustomer = __vue_normalize__$8(
  ...
  __vue_render__$9._withStripped = true;
    ...
    function __vue_normalize__$9(
      ...
      // For security concerns, we use only base name in production mode.
      component.__file = "/home/frappe/frappe-bench/apps/posawesome/posawesome/public/js/posapp/components/pos/Returns.vue";
    ...
    var Returns = __vue_normalize__$9(
          ...
          [
            _c(
              "v-col",
              {
                ...
                attrs: { xl: "5", lg: "6", md: "6", sm: "6", cols: "12" }
              },
              [_c("ItemsSelector")],
              1
            ),
            ...
            _c(
              ...
              {
                staticClass: "pos",
                attrs: { xl: "7", lg: "6", md: "6", sm: "6", cols: "12" }
              },
              [_c("Invoice")],
              1
            )
  ...
  __vue_render__$a._withStripped = true;
    ...
    var __vue_inject_styles__$a = function (inject) {
      if (!inject) { return }
      inject("data-v-c63f63d6_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", map: {"version":3,"sources":[],"names":[],"mappings":"","file":"Pos.vue"}, media: undefined });

    };
    /* scoped */
    var __vue_scope_id__$a = "data-v-c63f63d6";
    /* module identifier */
    ...
    function __vue_normalize__$a(
      ...
      // For security concerns, we use only base name in production mode.
      component.__file = "/home/frappe/frappe-bench/apps/posawesome/posawesome/public/js/posapp/components/pos/Pos.vue";
  ...
  __vue_render__$b._withStripped = true;
    ...
    var __vue_inject_styles__$b = function (inject) {
      if (!inject) { return }
      inject("data-v-1db5b7d4_0", { source: "\n.container1[data-v-1db5b7d4] {\n  margin-top: 0px;\n}\n", map: {"version":3,"sources":["/home/frappe/frappe-bench/apps/posawesome/posawesome/public/js/posapp/Home.vue"],"names":[],"mappings":";AAiDA;EACA,eAAA;AACA","file":"Home.vue","sourcesContent":["<template>\n  <v-app class=\"container1\">\n    <v-main>\n      <Navbar @changePage=\"setPage($event)\"></Navbar>\n      <keep-alive>\n        <component v-bind:is=\"page\" class=\"mx-4 md-4\"></component>\n      </keep-alive>\n    </v-main>\n  </v-app>\n</template>\n\n<script>\nimport Navbar from \"./components/Navbar.vue\";\nimport POS from \"./components/pos/Pos.vue\";\n\nexport default {\n  data: function () {\n    return {\n      page: \"POS\",\n    };\n  },\n  components: {\n    Navbar,\n    POS,\n  },\n  methods: {\n    setPage(page) {\n      this.page = page;\n    },\n    remove_frappe_nav() {\n      this.$nextTick(function () {\n        $(\".page-head\").remove();\n        $(\".navbar.navbar-default.navbar-fixed-top\").remove();\n      });\n    },\n  },\n  mounted() {\n    this.remove_frappe_nav();\n  },\n  updated() {},\n  created: function () {\n    setTimeout(() => {\n      this.remove_frappe_nav();\n    }, 1000);\n  },\n};\n</script>\n\n<style scoped>\n.container1 {\n  margin-top: 0px;\n}\n</style>"]}, media: undefined });

    };
    /* scoped */
    var __vue_scope_id__$b = "data-v-1db5b7d4";
    /* module identifier */
    ...
    function __vue_normalize__$b(
      ...
      // For security concerns, we use only base name in production mode.
      component.__file = "/home/frappe/frappe-bench/apps/posawesome/posawesome/public/js/posapp/Home.vue";
